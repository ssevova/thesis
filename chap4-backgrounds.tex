...
\begin{figure}
  ...
  \hspace{0.2 cm}
  \subfloat[][semileptonic $tW$]{\label{fig:tW}
    \feynmandiagram[vertical=b to c]{
      a [particle=\(b\)] -- [fermion] b -- [fermion] c -- [fermion, edge label=\(t\)] d -- [fermion] g [particle=\(b\)],
      c -- [gluon] e [particle=\(g\)], 
      d -- [boson, edge label=\(W^+\)] h, 
      i [particle=\(\ell^+\)] -- [fermion] h -- [fermion] j [particle=\(\nu_\ell\)],
      b -- [boson, edge label=\(W^-\)] f,
      k [particle=\(\bar{q}\)] -- [fermion] f -- [fermion] l [particle=\(q\)],
      f -- [opacity=0.0001] d,
      e -- [opacity=0.0001] a,
    };
  }
  \caption{Examples of~\protect\subref{fig:wjets} \Wjets,~\protect\subref{fig:tt1l} semileptonic \ttbar, and ~\protect\subref{fig:tW} semileptonic $tW$ diagrams that contribute to the fake lepton background.}
\end{figure}
